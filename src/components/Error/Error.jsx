...
export default function Error() {
	useEffect(() => {
		document.title="IETE - Error";
		Aos.init();
		 });
  return (
	
	  <div class="lg:px-24 w-[100%] h-[90vh] lg:py-24 md:py-20 md:px-44 px-4 py-24 items-center flex justify-center flex-col-reverse lg:flex-row md:gap-28 gap-16">
